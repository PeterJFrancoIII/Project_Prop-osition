...
| 2026-02-25 | Added sell-above-cost-basis check | 8th risk check: rejects sell orders where signal price < weighted avg cost basis from prior buys (Arch Public principle) | 0 |
